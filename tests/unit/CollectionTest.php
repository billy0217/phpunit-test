...
class ConnectionTest extends \PHPUnit\Framework\TestCase
{
	...
	/** @test */
	public function items_retures_match_items_passed_in(){
		$collection = new \App\Support\Collection([
			'one', 'two'
		]);
	...
	/** @test */
	// public function collection_is_isntance_of_iterator_aggregate(){
	// 	$collection = new \App\Support\Collection();

	// 	$this->assertInstanceOf(IneratorAggregate::class, $collection);
	// }
	...
	/** @test */
	public function conllection_can_be_merged_with_another_collection(){
	...
	public function return_json_encoded_item(){
		$collection = new \App\Support\Collection([
			['username' => 'alex'],
			['username' => 'billy']
		]);
